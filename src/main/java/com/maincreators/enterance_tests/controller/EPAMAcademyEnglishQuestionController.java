...
//                created001after, created001before, updated001after, updated001before);
        List <EPAMEnglishQuestion> questions = epamEnglishQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenOrderByQuestiontextDesc(
                created001after, created001before, updated001after, updated001before);
    ...
    public String questionsearch(@RequestParam String where,
        ...
        List <EPAMEnglishQuestion> questions100;//об'ява елемента List (допоміжного)
        ...
        List <EPAMEnglishQuestion> questions010;//об'ява елемента List (допоміжного)
        List <EPAMEnglishQuestion> questions110;//об'ява елемента List (допоміжного)
        List <EPAMEnglishQuestion> questions210;
        List <EPAMEnglishQuestion> questions310;
        List <EPAMEnglishQuestion> questions410;
        List <EPAMEnglishQuestion> questions510;
        List <EPAMEnglishQuestion> questions610;
        List <EPAMEnglishQuestion> questions710;
        List <EPAMEnglishQuestion> questions810;
        List <EPAMEnglishQuestion> questions910;
        ...
        if ((where.equals("everywhere")) && (what.equals("all")) && (!text.isEmpty())) {
            questions000 = epamEnglishQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndQuestiontextIsLike(
            ...
            questions000 = epamEnglishQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetween(
                    created001after, created001before, updated001after, updated001before);
            List <EPAMEnglishQuestion> newList = new ArrayList <EPAMEnglishQuestion>(questions000);
            questions = newList;
            ...
            List <EPAMEnglishQuestion> newList = new ArrayList <EPAMEnglishQuestion>(questions100);
            newList.addAll(questions200);
            newList.addAll(questions300);
            newList.addAll(questions400);
            newList.addAll(questions500);
            ...
            questions900 = epamEnglishQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption9textIsLikeAndOption9checkIsLike(
                    created909after, created909before, updated909after, updated909before, question909text, option909check);
            questions010 = epamEnglishQuestionRepository.(
            ...
            questions110 = epamEnglishQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption1textIsLikeAndOption1checkIsLike(
                    created111after, created111before, updated111after, updated111before, question111text, option111check);
            questions210 = epamEnglishQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption2textIsLikeAndOption2checkIsLike(
                    created212after, created212before, updated212after, updated212before, question212text, option212check);
            questions310 = epamEnglishQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption3textIsLikeAndOption3checkIsLike(
                    created313after, created313before, updated313after, updated313before, question313text, option313check);
            questions410 = epamEnglishQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption4textIsLikeAndOption4checkIsLike(
                    created414after, created414before, updated414after, updated414before, question414text, option414check);
            questions510 = epamEnglishQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption5textIsLikeAndOption5checkIsLike(
                    created515after, created515before, updated515after, updated515before, question515text, option515check);
            questions610 = epamEnglishQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption6textIsLikeAndOption6checkIsLike(
                    created616after, created616before, updated616after, updated616before, question616text, option616check);
            questions710 = epamEnglishQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption7textIsLikeAndOption7checkIsLike(
                    created717after, created717before, updated717after, updated717before, question717text, option717check);
            questions810 = epamEnglishQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption8textIsLikeAndOption8checkIsLike(
                    created818after, created818before, updated818after, updated818before, question818text, option818check);
            questions910 = epamEnglishQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption9textIsLikeAndOption9checkIsLike(
            ...
            questions900 = epamEnglishQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption9checkIsLikeAndOption9textIsNotLike(
                    created901after, created901before, updated901after, updated901before, option901check, "");
            questions110 = epamEnglishQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption1checkIsLikeAndOption1textIsNotLike(
                    created111after, created111before, updated111after, updated111before, option111check, "");
            questions210 = epamEnglishQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption2checkIsLikeAndOption2textIsNotLike(
                    created211after, created211before, updated211after, updated211before, option211check, "");
            questions310 = epamEnglishQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption3checkIsLikeAndOption3textIsNotLike(
                    created311after, created311before, updated311after, updated311before, option311check, "");
            questions410 = epamEnglishQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption4checkIsLikeAndOption4textIsNotLike(
                    created411after, created411before, updated411after, updated411before, option411check, "");
            questions510 = epamEnglishQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption5checkIsLikeAndOption5textIsNotLike(
                    created511after, created511before, updated511after, updated511before, option511check, "");
            questions610 = epamEnglishQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption6checkIsLikeAndOption6textIsNotLike(
                    created611after, created611before, updated611after, updated611before, option611check, "");
            questions710 = epamEnglishQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption7checkIsLikeAndOption7textIsNotLike(
                    created711after, created711before, updated711after, updated711before, option711check, "");
            questions810 = epamEnglishQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption8checkIsLikeAndOption8textIsNotLike(
                    created811after, created811before, updated811after, updated811before, option811check, "");
            questions910 = epamEnglishQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption9checkIsLikeAndOption9textIsNotLike(
