...
//    private EnglishGrammarRuleRepository englishGrammarRuleRepository;
    ...
    private String softservejavauploaduploadPath;
    ...
    public String questionsearch(@RequestParam String where,
        ...
        List <SoftServeJavaQuestion> questions100;//об'ява елемента List (допоміжного)
        ...
        List <SoftServeJavaQuestion> questions010;//об'ява елемента List (допоміжного)
        List <SoftServeJavaQuestion> questions110;//об'ява елемента List (допоміжного)
        List <SoftServeJavaQuestion> questions210;
        List <SoftServeJavaQuestion> questions310;
        List <SoftServeJavaQuestion> questions410;
        List <SoftServeJavaQuestion> questions510;
        List <SoftServeJavaQuestion> questions610;
        List <SoftServeJavaQuestion> questions710;
        List <SoftServeJavaQuestion> questions810;
        List <SoftServeJavaQuestion> questions910;
        ...
        if ((where.equals("everywhere")) && (what.equals("all")) && (!text.isEmpty())) {
            questions000 = softServeJavaQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndQuestiontextIsLike(
            ...
            questions000 = softServeJavaQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetween(
                    created001after, created001before, updated001after, updated001before);
            List <SoftServeJavaQuestion> newList = new ArrayList <SoftServeJavaQuestion>(questions000);
            questions = newList;
            ...
            questions000 = softServeJavaQuestionRepository.(
            ...
            List <SoftServeJavaQuestion> newList = new ArrayList <SoftServeJavaQuestion>(questions100);
            newList.addAll(questions200);
            newList.addAll(questions300);
            newList.addAll(questions400);
            newList.addAll(questions500);
            ...
            questions110 = softServeJavaQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption1textIsLikeAndOption1checkIsLike(
                    created111after, created111before, updated111after, updated111before, question111text, option111check);
            questions210 = softServeJavaQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption2textIsLikeAndOption2checkIsLike(
                    created212after, created212before, updated212after, updated212before, question212text, option212check);
            questions310 = softServeJavaQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption3textIsLikeAndOption3checkIsLike(
                    created313after, created313before, updated313after, updated313before, question313text, option313check);
            questions410 = softServeJavaQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption4textIsLikeAndOption4checkIsLike(
                    created414after, created414before, updated414after, updated414before, question414text, option414check);
            questions510 = softServeJavaQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption5textIsLikeAndOption5checkIsLike(
                    created515after, created515before, updated515after, updated515before, question515text, option515check);
            questions610 = softServeJavaQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption6textIsLikeAndOption6checkIsLike(
                    created616after, created616before, updated616after, updated616before, question616text, option616check);
            questions710 = softServeJavaQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption7textIsLikeAndOption7checkIsLike(
                    created717after, created717before, updated717after, updated717before, question717text, option717check);
            questions810 = softServeJavaQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption8textIsLikeAndOption8checkIsLike(
                    created818after, created818before, updated818after, updated818before, question818text, option818check);
            questions910 = softServeJavaQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption9textIsLikeAndOption9checkIsLike(
            ...
            questions900 = softServeJavaQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption9checkIsLikeAndOption9textIsNotLike(
                    created901after, created901before, updated901after, updated901before, option901check, "");
            questions110 = softServeJavaQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption1checkIsLikeAndOption1textIsNotLike(
                    created111after, created111before, updated111after, updated111before, option111check, "");
            questions210 = softServeJavaQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption2checkIsLikeAndOption2textIsNotLike(
                    created211after, created211before, updated211after, updated211before, option211check, "");
            questions310 = softServeJavaQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption3checkIsLikeAndOption3textIsNotLike(
                    created311after, created311before, updated311after, updated311before, option311check, "");
            questions410 = softServeJavaQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption4checkIsLikeAndOption4textIsNotLike(
                    created411after, created411before, updated411after, updated411before, option411check, "");
            questions510 = softServeJavaQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption5checkIsLikeAndOption5textIsNotLike(
                    created511after, created511before, updated511after, updated511before, option511check, "");
            questions610 = softServeJavaQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption6checkIsLikeAndOption6textIsNotLike(
                    created611after, created611before, updated611after, updated611before, option611check, "");
            questions710 = softServeJavaQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption7checkIsLikeAndOption7textIsNotLike(
                    created711after, created711before, updated711after, updated711before, option711check, "");
            questions810 = softServeJavaQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption8checkIsLikeAndOption8textIsNotLike(
                    created811after, created811before, updated811after, updated811before, option811check, "");
            questions910 = softServeJavaQuestionRepository.findByDateofcreateIsBetweenAndDateoflastchangeIsBetweenAndOption9checkIsLikeAndOption9textIsNotLike(
