...
@Table(name = "softservejavaquestion")
public class SoftServeJavaQuestion {
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    private Integer id;

    @Pattern(regexp = "[S][o][f][t][S][e][r][v][e]",
            message = "Attention! Was stopped attempt to add in database invalid data.")
    @Column(name = "company")
    private String company;

    @Pattern(regexp = "[J][a][v][a]",
            message = "Attention! Was stopped attempt to add in database invalid data.")
    @Column(name = "subject")
    ...
    public SoftServeJavaQuestion() {
    }

    public SoftServeJavaQuestion(String company,
                            String subject,
                            String grammarrule,
